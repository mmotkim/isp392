...
<div class="container" style="margin-top: 40px">
    ...
    <form action="EditParent" method="post">
            ...
            <div class="col-md-6">
                <div class="mb-4">
                    <h5 class="card-title text-primary">
                        User Profile <span class="text-muted">(User ID: ${u1.getUserId()})</span>
                    </h5>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="col-lg-16">
                <div class="">
                    <input name="id" id="id" type="hidden" value="${u1.getUserId()}">
                    ...
                    <div class="form-row input-group mb-3 d-flex">
                        ...
                        <li id="name" name="name"  class="form-control"  aria-label=""
                            aria-describedby="basic-addon2"  >${u1.getUsername()}</li>
                    </div>
                    <div class="form-row input-group mb-3 d-flex">
                        <label class="input-group-text">Gender</label>
                        <li id="gender" name="gender"  class="form-control" placeholder="gender" aria-label="Your gender"
                            aria-describedby="basic-addon2" >${u1.getGender().equals(1) ? "Male" : "Female"}</li>
                    </div>
                    <div class="form-row input-group mb-3">
                        <label class="input-group-text"> Email:</label>
                        <li id="email" name="email"  class="form-control" placeholder="email" aria-label="Your email"
                            aria-describedby="basic-addon2" >${u1.getEmail()}</li>
                    </div>
                    <div class="form-row input-group mb-3">
                        <label class="input-group-text"> Birthday:</label>
                        <li id="dob" name="dob"  class="form-control" placeholder="DOB" aria-label="Your DoB"
                            aria-describedby="basic-addon2" >${u1.getDob()}</li>
                    </div>

                    <div class="form-row input-group mb-3">
                        <label class="input-group-text"> Address:</label>
                        <li id="address" name="address"  class="form-control" placeholder="Address" aria-label="Your Address"
                            aria-describedby="basic-addon2">${u1.getAddress()}</li>
                    </div>
                    ...
                    <div class="form-row input-group mb-3 d-flex">
                        ...
                        <li id="Active" name="Active"  class="form-control" placeholder="Active" aria-label="Your Active"
                            aria-describedby="basic-addon2" >${u1.isActive().equals(1) ? "Active" : "Inactive"}</li>
                    </div>

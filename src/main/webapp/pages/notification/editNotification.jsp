    ...
    <form action="EditNotification" method="post">
            ...
            <div class="col-md-6">
                <div class="mb-4">
                    <h5 class="card-title text-primary">
                        ...
                        1. Edit Notification Details. <span
                            class="text-muted">(Notification ID: ${n.getNotificationId()})</span>
                    </h5>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-16">
                <div class="">
                    ...
                    <div class="form-row input-group mb-3 d-flex">
                        ...
                        <input name="title" id="title" type="text" value="${n.getTitle()}" class="form-control"
                               placeholder="Notification Name" aria-label="Your Notification Name"
                               aria-describedby="basic-addon2" required/>
                    </div>
                    <div class="form-row input-group mb-3">
                        <label class="input-group-text" for="description">Enter Notification Description:</label>
                        <input name="description" id="description" type="text" value="${n.getDescription()}"
                               class="form-control" placeholder="Notification Description"
                               aria-label="Your Notification Description" aria-describedby="basic-addon2"/>
                    </div>
                    <div class="form-row input-group mb-3 d-flex">
                        <label class="input-group-text" for="process">Enter Start Date:</label>
                        <input name="process" id="process" type="date" value="${n.getProcessingDate()}"
                               onchange="TDate()" class="form-control" placeholder="Notification Start Date"
                               aria-label="Your Notification Start Date" aria-describedby="basic-addon2" required/>
                    </div>
                    <div class="form-row input-group mb-3 d-flex">
                        <label class="input-group-text" for="end">Enter End Date:</label>
                        <input name="end" id="end" type="date" value="${n.getEndDate()}" onchange="TDate()"
                               class="form-control" placeholder="Notification End Date"
                               aria-label="Your Notification End Date" aria-describedby="basic-addon2" required/>
                    </div>
        ...
        <div>
            <div class="search-box pb-3">
                ...
                <div class="pb-3">
                    <button type="button" class="btn btn-primary px-2 py-1" onclick="uncheckRadio()">
                        <i class="bi bi-x-circle"></i> Deselect Activity
                    </button>
                </div>

                <input type="text" id="search-input" class="form-control"
                       placeholder="Search by Activity Name or Activity Type">
            </div>
                        ...
                        <tr>
                            <td class="select-cell">
                                <div class="form-check">
                                    <input type="radio"
                                           class="form-check-input" ${(n.getActivityId() == t.getActivityId()) ? 'checked' : ''}>
                                </div>
                            </td>
            ...
            <div class="d-flex  align-items-center justify-content-end gap mb-3">
                <div>
                    ...
                    <button type="submit" data-bs-toggle="modal" data-bs-target=".add-new"
                            ...
                            class="bi bi-check-lg me-1 "></i> Confirm Edit Notification
                    </button>
                </div>
            </div>
        </div>

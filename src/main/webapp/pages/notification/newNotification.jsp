            ...
            <div class="col-lg-16">
                <div class="">
                    ...
                    <div class="form-row input-group mb-3 d-flex">
                        ...
                        <input name="title" id="name" type="text" class="form-control" placeholder="Notification Name"
                               aria-label="Your Notification Name" aria-describedby="basic-addon2" required/>
                    </div>
                    <div class="form-row input-group mb-3">
                        <label class="input-group-text" for="description">Enter Notification Description:</label>
                        <input name="description" id="description" type="text" class="form-control"
                               placeholder="Notification Description" aria-label="Your Notification Description"
                               aria-describedby="basic-addon2" />
                    </div>
                    <div class="form-row input-group mb-3 d-flex">
                        <label class="input-group-text" for="process">Enter Start Date:</label>
                        <input name="process" id="process" type="date" onchange="TDate()" class="form-control"
                               placeholder="Notification Start Date" aria-label="Your Notification Start Date"
                               aria-describedby="basic-addon2" required/>
                    </div>
                    <div class="form-row input-group mb-3 d-flex">
                        <label class="input-group-text" for="end">Enter End Date:</label>
                        <input name="end" id="end" type="date" onchange="TDate()" class="form-control"
                               placeholder="Notification End Date" aria-label="Your Notification End Date"
                               aria-describedby="basic-addon2" required/>
                    </div>
            ...
            <div class="d-flex align-items-center justify-content-end gap mb-3">
                <div>
                    ...
                    <button type="submit" data-bs-toggle="modal" data-bs-target=".add-new"
                            class="btn btn-primary"><i class="bx bx-plus me-1"></i> Confirm Create Notification
                    </button>
                </div>
            </div>
        </div>

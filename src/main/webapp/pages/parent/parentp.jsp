      ...
      <div class="col-md-6">
        <div class="mb-4">
          <h5 class="card-title text-primary">
            Parent Profile <span class="text-muted">(Parent ID: ${s1.getUserId()})</span>
          </h5>
        </div>
      </div>
    </div>
        ...
        <div class="">
          ...
          <div class="form-row input-group mb-3 d-flex">
            ...
            <li id="Active" name="Active"  class="form-control" placeholder="Active" aria-label="Your Active"
                aria-describedby="basic-addon2" >${p1.getActive().equals(1) ? "Active" : "Inactive"}</li>
          </div>

    ...
    <div class="col-lg-16">
      <div class="">
        <div class="form-row input-group mb-3 d-flex">
          ...
          <input name="name" id="name" type="text" class="form-control" placeholder="${aClass.getClassName()}" aria-label="Your Class Name"
    ...
    <div class="d-flex  align-items-center justify-content-end gap mb-3">
      ...
      <div>
        ...
        <button  type="submit" data-bs-toggle="modal" data-bs-target=".add-new" class=" btn btn-primary"><i
                class="bx bx-plus me-1 "></i> Confirm Changes</button>
      </div>
    </div>
  </div>
